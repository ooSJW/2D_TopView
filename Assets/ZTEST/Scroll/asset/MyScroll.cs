...
namespace EnhancedScrollerDemos.SuperSimpleDemo
{
    ...
    /// </summary>
    public class MyScroll : MonoBehaviour, IEnhancedScrollerDelegate
    {
        /// <summary>
        /// Internal representation of our data. Note that the scroller will never see
        /// this, so it separates the data from the layout using MVC principles.
        /// </summary>
        private SmallList<ItemData> _data;
        ...
        private void LoadLargeData()
        {
            ...
            _data = new SmallList<ItemData>();
            for (var i = 0; i < 100; i++)
                _data.Add(new ItemData() { someText = "Cell Data Index " + i.ToString() });
        ...
        private void LoadSmallData()
        {
            ...
            _data.Add(new ItemData() { someText = "A" });
            _data.Add(new ItemData() { someText = "B" });
            _data.Add(new ItemData() { someText = "C" });
        ...
        public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
        {
            ...
            ItemCellView cellView = scroller.GetCellView(cellViewPrefab) as ItemCellView;
